...
class PingStatistics(Statistics):
    ...
    def to_dict(self):
        return {
            ...
            'delay':self._delay.to_dict(),
            'average_delay':self._average_delay.to_dict(),
            'average_median_delay':self._average_median_delay.to_dict(),
            'average_packet_loss':self._average_packet_loss.to_dict(),
